...
if(isset($_SESSION['usuario']['basic_data']['Email'], $_SESSION['usuario']['basic_data']['password'])&&$_SESSION['usuario']['basic_data']['Email']!=''&&$_SESSION['usuario']['basic_data']['password']!=''){
	$sesion_usuario  = $_SESSION['usuario']['basic_data']['Email'];
...
if($sesion_Activa!=0){
	...
	$rowUserId = db_select_nrows (false, 'idUsuario','usuarios_listado', '', 'email = "'.$sesion_usuario.'" AND password = "'.$sesion_password.'"', $dbConn, 'Ninguno', basename($_SERVER["REQUEST_URI"], ".php"), 'rowUserId');

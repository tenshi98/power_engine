...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => '../../../'.$_GET['emp_path'].'/ClientFiles/_seguridad/',                 // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/../../../'.$_GET['emp_path'].'/ClientFiles/_seguridad/', // URL to files (REQUIRED)
		...
		array(
			'id'            => '1',
			'driver'        => 'Trash',
			'path'          => '../../../'.$_GET['emp_path'].'/ClientFiles/_seguridad/.trash/',
			'tmbURL'        => dirname($_SERVER['PHP_SELF']) . '../../../'.$_GET['emp_path'].'/ClientFiles/_seguridad/.trash/',
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too

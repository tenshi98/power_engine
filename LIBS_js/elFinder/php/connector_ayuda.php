...
$opts = array(
	// 'debug' => true,
	'roots' => array(
		//Carpeta con archivos de ayuda
		array(
			'driver'        => 'LocalFileSystem',              // driver for accessing file system (REQUIRED)
			'path'          => '../../../LIBS_files/Ayuda/',                 // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/../../../LIBS_files/Ayuda/', // URL to files (REQUIRED)
		...
		/*array(
			'id'            => '1',
			'driver'        => 'Trash',
			'path'          => '../../../LIBS_files/Ayuda/.trash/',
			'tmbURL'        => dirname($_SERVER['PHP_SELF']) . '../../../LIBS_files/Ayuda/.trash/',
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too

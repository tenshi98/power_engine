...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => '../../../'.$_GET['emp_path'].'/ClientFiles/_public/'.$_GET['id_emp'].'/',                 // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/../../../'.$_GET['emp_path'].'/ClientFiles/_public/'.$_GET['id_emp'].'/', // URL to files (REQUIRED)

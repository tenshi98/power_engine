...
//Nivel de permiso
if(isset($_GET['prm'])&&$_GET['prm']!=''){
	switch ($_GET['prm']) {
		case 1: $x_read = true; $x_write = false; $x_rm = false; break;
		case 2: $x_read = true; $x_write = true;  $x_rm = false; break;
		case 3: $x_read = true; $x_write = true;  $x_rm = true;  break;
	}
}else{
	$x_read   = true;
    $x_write  = true;
...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => '../../../'.$_GET['emp_path'].'/ClientFiles/_public/',                 // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/../../../'.$_GET['emp_path'].'/ClientFiles/_public/', // URL to files (REQUIRED)
			'trashHash'     => 't1_Lw',                     // elFinder's hash of trash folder
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
			'uploadDeny'    => array('all'),                // All Mimetypes not allowed to upload
			'uploadAllow'   => array('image/x-ms-bmp','application/x-rar','image/jpg','image/png','image/gif','image/jpeg','image/bmp','application/msword','application/vnd.ms-word','application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'application/msexcel','application/vnd.ms-excel','application/vnd.openxmlformats-officedocument.spreadsheetml.sheet','application/mspowerpoint','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.presentationml.presentation','application/pdf','application/octet-stream','application/x-real','application/vnd.adobe.xfdf','application/vnd.fdf','binary/octet-stream','text/plain','text/richtext','application/rtf','application/x-zip-compressed','application/zip','multipart/x-zip','application/x-7z-compressed','application/x-rar-compressed','application/gzip','application/x-gzip','application/x-gtar','application/x-tgz','application/octet-stream'), // Mimetype `image` and `text/plain` allowed to upload
		...
		array(
			'id'            => '1',
			'driver'        => 'Trash',
			'path'          => '../../../'.$_GET['emp_path'].'/ClientFiles/_public/.trash/',
			'tmbURL'        => dirname($_SERVER['PHP_SELF']) . '../../../'.$_GET['emp_path'].'/ClientFiles/_public/.trash/',
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
			'uploadDeny'    => array('all'),                // Recomend the same settings as the original volume that uses the trash
			'uploadAllow'   => array('image/jpg','image/png','image/gif','image/jpeg','image/bmp','application/msword','application/vnd.ms-word','application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'application/msexcel','application/vnd.ms-excel','application/vnd.openxmlformats-officedocument.spreadsheetml.sheet','application/mspowerpoint','application/vnd.ms-powerpoint','application/vnd.openxmlformats-officedocument.presentationml.presentation','application/pdf','application/octet-stream','application/x-real','application/vnd.adobe.xfdf','application/vnd.fdf','binary/octet-stream','text/plain','text/richtext','application/rtf','application/x-zip-compressed','application/zip','multipart/x-zip','application/x-7z-compressed','application/x-rar-compressed','application/gzip','application/x-gzip','application/x-gtar','application/x-tgz','application/octet-stream'), // Mimetype `image` and `text/plain` allowed to upload

...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_Autolinker__ = __webpack_require__(/*! Autolinker */ 174);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_Common_Mime__ = __webpack_require__(/*! Common/Mime */ 103);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_Common_Jassl__ = __webpack_require__(/*! Common/Jassl */ 76);
...
var detectDropdownVisibility = __WEBPACK_IMPORTED_MODULE_2_____default.a.debounce(function () {
	__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5_Common_Globals__["dropdownVisibility"])(!!__WEBPACK_IMPORTED_MODULE_2_____default.a.find(__WEBPACK_IMPORTED_MODULE_5_Common_Globals__["data"].aBootstrapDropdowns, function (item) {
...
function mailToHelper(mailToUrl, PopupComposeVoreModel) {
	if (mailToUrl && 'mailto:' === mailToUrl.toString().substr(0, 7).toLowerCase()) {
		...
		var email = mailToUrl.replace(/\?.+$/, ''),
		    ...
		    EmailModel = __webpack_require__(/*! Model/Email */ 39).default,
		...
		__webpack_require__(/*! Knoin/Knoin */ 8).showScreenPopup(PopupComposeVoreModel, [__WEBPACK_IMPORTED_MODULE_6_Common_Enums__["ComposeType"].Empty, null, to, cc, bcc, isUnd(params.subject) ? null : pString(decodeURIComponent(params.subject)), isUnd(params.body) ? null : plainToHtml(pString(decodeURIComponent(params.body)))]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_pikaday__ = __webpack_require__(/*! pikaday */ 165);
...
ko.bindingHandlers.editor = {
	init: function init(element, fValueAccessor) {
		...
		var fValue = fValueAccessor(),
		    HtmlEditor = __webpack_require__(/*! Common/HtmlEditor */ 75).default,
...
ko.bindingHandlers.tooltip = {
	...
	update: function update(element, fValueAccessor) {
		...
		if ((!Globals.bMobileDevice || isMobile) && element.__opentip) {
			var sValue = !ko.isObservable(fValue) && __WEBPACK_IMPORTED_MODULE_1_____default.a.isFunction(fValue) ? fValue() : ko.unwrap(fValue);
			if (sValue) {
				element.__opentip.setContent('on' === ($el.data('tooltip-i18n') || 'on') ? __webpack_require__(/*! Common/Translator */ 9).i18n(sValue) : sValue);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2____ = __webpack_require__(/*! $ */ 12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_____default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2____);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_key__ = __webpack_require__(/*! key */ 20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_hasher__ = __webpack_require__(/*! hasher */ 175);
...
function reload(admin, language) {
	...
	return new __WEBPACK_IMPORTED_MODULE_9_Promise___default.a(function (resolve, reject) {
		__WEBPACK_IMPORTED_MODULE_2_____default.a.ajax({
			url: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Common_Links__["e" /* langLink */])(language, admin),
			dataType: 'script',
			cache: true
		}).then(function () {
			__WEBPACK_IMPORTED_MODULE_1_____default.a.delay(function () {
...
/* exports used: root, rootAdmin, populateAuthSuffix, rootUser, langLink, settings, phpInfo, ajax, userBackground, mailBox, socialGoogle, socialTwitter, socialFacebook, openPgpWorkerJs, openPgpJs, upload, attachmentDownload, attachmentPreview, attachmentThumbnailPreview, attachmentFramed, attachmentPreviewAsPlain, sound, exportContactsVcf, exportContactsCsv, uploadContacts, emptyContactPic, avatarLink, themePreviewLink, uploadBackground, inbox, append, change, notificationMailIcon, messageViewLink, messageDownloadLink, subQueryPrefix */
/*!*****************************!*\
  !*** ./dev/Common/Links.js ***!
  \*****************************/
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["c"] = populateAuthSuffix;
/* harmony export (immutable) */ __webpack_exports__["J"] = subQueryPrefix;
/* harmony export (immutable) */ __webpack_exports__["a"] = root;
/* harmony export (immutable) */ __webpack_exports__["b"] = rootAdmin;
/* harmony export (immutable) */ __webpack_exports__["d"] = rootUser;
/* unused harmony export attachmentRaw */
/* harmony export (immutable) */ __webpack_exports__["q"] = attachmentDownload;
/* harmony export (immutable) */ __webpack_exports__["r"] = attachmentPreview;
/* harmony export (immutable) */ __webpack_exports__["s"] = attachmentThumbnailPreview;
/* harmony export (immutable) */ __webpack_exports__["u"] = attachmentPreviewAsPlain;
/* harmony export (immutable) */ __webpack_exports__["t"] = attachmentFramed;
/* unused harmony export serverRequest */
/* harmony export (immutable) */ __webpack_exports__["p"] = upload;
/* harmony export (immutable) */ __webpack_exports__["y"] = uploadContacts;
/* harmony export (immutable) */ __webpack_exports__["C"] = uploadBackground;
/* harmony export (immutable) */ __webpack_exports__["E"] = append;
/* harmony export (immutable) */ __webpack_exports__["F"] = change;
/* harmony export (immutable) */ __webpack_exports__["h"] = ajax;
/* harmony export (immutable) */ __webpack_exports__["H"] = messageViewLink;
/* harmony export (immutable) */ __webpack_exports__["I"] = messageDownloadLink;
/* harmony export (immutable) */ __webpack_exports__["A"] = avatarLink;
/* unused harmony export publicLink */
/* harmony export (immutable) */ __webpack_exports__["i"] = userBackground;
/* harmony export (immutable) */ __webpack_exports__["g"] = phpInfo;
/* harmony export (immutable) */ __webpack_exports__["e"] = langLink;
/* harmony export (immutable) */ __webpack_exports__["w"] = exportContactsVcf;
/* harmony export (immutable) */ __webpack_exports__["x"] = exportContactsCsv;
/* harmony export (immutable) */ __webpack_exports__["k"] = socialGoogle;
/* harmony export (immutable) */ __webpack_exports__["l"] = socialTwitter;
/* harmony export (immutable) */ __webpack_exports__["m"] = socialFacebook;
/* unused harmony export staticPrefix */
/* harmony export (immutable) */ __webpack_exports__["z"] = emptyContactPic;
/* harmony export (immutable) */ __webpack_exports__["v"] = sound;
/* harmony export (immutable) */ __webpack_exports__["G"] = notificationMailIcon;
/* harmony export (immutable) */ __webpack_exports__["o"] = openPgpJs;
/* harmony export (immutable) */ __webpack_exports__["n"] = openPgpWorkerJs;
/* unused harmony export openPgpWorkerPath */
/* harmony export (immutable) */ __webpack_exports__["B"] = themePreviewLink;
/* harmony export (immutable) */ __webpack_exports__["D"] = inbox;
/* harmony export (immutable) */ __webpack_exports__["f"] = settings;
/* unused harmony export about */
/* unused harmony export admin */
/* harmony export (immutable) */ __webpack_exports__["j"] = mailBox;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_window__ = __webpack_require__(/*! window */ 11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_window___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_window__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_Common_Utils__ = __webpack_require__(/*! Common/Utils */ 1);
...
module.exports = { "default": __webpack_require__(/*! core-js/library/fn/object/get-own-property-descriptor */ 131), __esModule: true };

/***/ }),
/* 16 */,
/* 17 */
/* exports provided: AbstractComponent, componentExportHelper */
/* exports used: componentExportHelper, AbstractComponent */
/*!***********************************!*\
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return AbstractComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return componentExportHelper; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck__ = __webpack_require__(/*! babel-runtime/helpers/classCallCheck */ 0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1____ = __webpack_require__(/*! $ */ 12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_____default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1____);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_Common_Translator__ = __webpack_require__(/*! Common/Translator */ 9);
		...
		viewModel: {
			createViewModel: function createViewModel(params, componentInfo) {
				...
				if (componentInfo && componentInfo.element) {
					...
					if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_Common_Utils__["isUnd"])(params.inline) && __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].unwrap(params.inline)) {
...
/* exports used: RAINLOOP_TRIAL_KEY, IMAP_DEFAULT_PORT, SIEVE_DEFAULT_PORT, SMTP_DEFAULT_PORT, TOKEN_ERROR_LIMIT, AJAX_ERROR_LIMIT, DEFAULT_AJAX_TIMEOUT, UNUSED_OPTION_VALUE, CONTACTS_PER_PAGE, MESSAGES_PER_PAGE_VALUES, DATA_IMAGE_USER_DOT_PIC, CLIENT_SIDE_STORAGE_INDEX_NAME, MESSAGES_PER_PAGE, MESSAGE_BODY_CACHE_LIMIT, CONTACTS_SYNC_AJAX_TIMEOUT, SEARCH_AJAX_TIMEOUT, SAVE_MESSAGE_AJAX_TIMEOUT, SEND_MESSAGE_AJAX_TIMEOUT */
/*!******************************!*\
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return MESSAGES_PER_PAGE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return MESSAGES_PER_PAGE_VALUES; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return CONTACTS_PER_PAGE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return DEFAULT_AJAX_TIMEOUT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return SEARCH_AJAX_TIMEOUT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return SEND_MESSAGE_AJAX_TIMEOUT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return SAVE_MESSAGE_AJAX_TIMEOUT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return CONTACTS_SYNC_AJAX_TIMEOUT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return UNUSED_OPTION_VALUE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return CLIENT_SIDE_STORAGE_INDEX_NAME; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return IMAP_DEFAULT_PORT; });
/* unused harmony export IMAP_DEFAULT_SECURE_PORT */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return SMTP_DEFAULT_PORT; });
/* unused harmony export SMTP_DEFAULT_SECURE_PORT */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return SIEVE_DEFAULT_PORT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return MESSAGE_BODY_CACHE_LIMIT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return AJAX_ERROR_LIMIT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return TOKEN_ERROR_LIMIT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RAINLOOP_TRIAL_KEY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return DATA_IMAGE_USER_DOT_PIC; });
...
/* exports used: runHook, runSettingsViewModelHooks, addSettingsViewModel, addSettingsViewModelForAdmin, addHook, mainSettingsGet, settingsGet, remoteRequest */
/*!*******************************!*\
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["e"] = addHook;
/* harmony export (immutable) */ __webpack_exports__["a"] = runHook;
/* harmony export (immutable) */ __webpack_exports__["f"] = mainSettingsGet;
/* harmony export (immutable) */ __webpack_exports__["h"] = remoteRequest;
/* harmony export (immutable) */ __webpack_exports__["c"] = addSettingsViewModel;
/* harmony export (immutable) */ __webpack_exports__["d"] = addSettingsViewModelForAdmin;
/* harmony export (immutable) */ __webpack_exports__["b"] = runSettingsViewModelHooks;
/* harmony export (immutable) */ __webpack_exports__["g"] = settingsGet;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0____ = __webpack_require__(/*! _ */ 6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_____default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0____);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_Common_Utils__ = __webpack_require__(/*! Common/Utils */ 1);
...
var anObject       = __webpack_require__(/*! ./_an-object */ 42)
  ...
  , toPrimitive    = __webpack_require__(/*! ./_to-primitive */ 69)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2____ = __webpack_require__(/*! $ */ 12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_____default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2____);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_moment__ = __webpack_require__(/*! moment */ 72);
 ...
 */
function getApp() {
  return __webpack_require__(/*! App/Admin */ 177).default;
}
...
}(__WEBPACK_IMPORTED_MODULE_6_Component_Abstract__["b" /* AbstractComponent */]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_Component_AbstracCheckbox__ = __webpack_require__(/*! Component/AbstracCheckbox */ 77);
...
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_Component_Abstract__["a" /* componentExportHelper */])(CheckboxComponent, 'CheckboxComponent'));
...
var AppAdminStore = function (_AbstractAppStore) {
	...
	function AppAdminStore() {
		...
		_this.determineUserLanguage = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(false);
		_this.determineUserDomain = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(false);

		_this.weakPassword = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(false);
...
var anObject    = __webpack_require__(/*! ./_an-object */ 42)
  , dPs         = __webpack_require__(/*! ./_object-dps */ 146)
  , enumBugKeys = __webpack_require__(/*! ./_enum-bug-keys */ 59)
...
var pIE            = __webpack_require__(/*! ./_object-pie */ 64)
  , createDesc     = __webpack_require__(/*! ./_property-desc */ 51)
  , toIObject      = __webpack_require__(/*! ./_to-iobject */ 23)
  , toPrimitive    = __webpack_require__(/*! ./_to-primitive */ 69)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_inherits___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_inherits__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ko__ = __webpack_require__(/*! ko */ 2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_key__ = __webpack_require__(/*! key */ 20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_Common_Translator__ = __webpack_require__(/*! Common/Translator */ 9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_Knoin_Knoin__ = __webpack_require__(/*! Knoin/Knoin */ 8);
  ...
  */
	function AbstracCheckbox() {
		...
		if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["isUnd"])(_this.value) || !_this.value.subscribe) {
			_this.value = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["isUnd"])(_this.value) ? false : !!_this.value);
		}
		...
		if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["isUnd"])(_this.enable) || !_this.enable.subscribe) {
			_this.enable = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["isUnd"])(_this.enable) ? true : !!_this.enable);
		}
		...
		if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["isUnd"])(_this.disable) || !_this.disable.subscribe) {
			_this.disable = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["isUnd"])(_this.disable) ? false : !!_this.disable);
		}
...
}(__WEBPACK_IMPORTED_MODULE_5_Component_Abstract__["b" /* AbstractComponent */]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ko__ = __webpack_require__(/*! ko */ 2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_Common_Utils__ = __webpack_require__(/*! Common/Utils */ 1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_Knoin_Knoin__ = __webpack_require__(/*! Knoin/Knoin */ 8);
...
var _iterator = __webpack_require__(/*! ../core-js/symbol/iterator */ 129);
...
var aFunction = __webpack_require__(/*! ./_a-function */ 135);
...
module.exports = !__webpack_require__(/*! ./_descriptors */ 31) && !__webpack_require__(/*! ./_fails */ 44)(function(){
...
var LIBRARY        = __webpack_require__(/*! ./_library */ 61)
  ...
  , $iterCreate    = __webpack_require__(/*! ./_iter-create */ 142)
...
var $keys      = __webpack_require__(/*! ./_object-keys-internal */ 89)
  , hiddenKeys = __webpack_require__(/*! ./_enum-bug-keys */ 59).concat('length', 'prototype');
...
var has          = __webpack_require__(/*! ./_has */ 26)
  , toIObject    = __webpack_require__(/*! ./_to-iobject */ 23)
  , arrayIndexOf = __webpack_require__(/*! ./_array-includes */ 137)(false)
  , IE_PROTO     = __webpack_require__(/*! ./_shared-key */ 66)('IE_PROTO');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_Common_Translator__ = __webpack_require__(/*! Common/Translator */ 9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_Model_Email__ = __webpack_require__(/*! Model/Email */ 39);
...
/* harmony default export */ __webpack_exports__["a"] = (function (App) {
	...
	rl.addSettingsViewModel = __WEBPACK_IMPORTED_MODULE_4_Common_Plugins__["c" /* addSettingsViewModel */];
	rl.addSettingsViewModelForAdmin = __WEBPACK_IMPORTED_MODULE_4_Common_Plugins__["d" /* addSettingsViewModelForAdmin */];

	rl.addHook = __WEBPACK_IMPORTED_MODULE_4_Common_Plugins__["e" /* addHook */];
	rl.settingsGet = __WEBPACK_IMPORTED_MODULE_4_Common_Plugins__["f" /* mainSettingsGet */];
	rl.pluginSettingsGet = __WEBPACK_IMPORTED_MODULE_4_Common_Plugins__["g" /* settingsGet */];
	rl.pluginRemoteRequest = __WEBPACK_IMPORTED_MODULE_4_Common_Plugins__["h" /* remoteRequest */];
...
var CapaAdminStore = function () {
	function CapaAdminStore() {
		...
		this.additionalAccounts = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false);
		this.identities = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false);
		this.gravatar = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false);
		this.attachmentThumbnails = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false);
		this.sieve = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false);
		this.filters = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false);
		this.themes = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(true);
		this.userBackground = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false);
		this.openPGP = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false);
		this.twoFactorAuth = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false);
		this.twoFactorAuthForce = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false);
		this.templates = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false);
	}
...
var DomainAdminStore = function DomainAdminStore() {
	...
	this.domains = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observableArray([]);
	this.domains.loading = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false).extend({ 'throttle': 100 });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_key__ = __webpack_require__(/*! key */ 20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_key___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_key__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_ssm__ = __webpack_require__(/*! ssm */ 176);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_Common_Translator__ = __webpack_require__(/*! Common/Translator */ 9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18_Stores_Theme__ = __webpack_require__(/*! Stores/Theme */ 57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19_Stores_Social__ = __webpack_require__(/*! Stores/Social */ 54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20_Knoin_Knoin__ = __webpack_require__(/*! Knoin/Knoin */ 8);
...
var AbstractApp = function (_AbstractBoot) {
  ...
  */
	...
	AbstractApp.prototype.redirectToAdminPanel = function redirectToAdminPanel() {
		__WEBPACK_IMPORTED_MODULE_5_____default.a.delay(function () {
			__WEBPACK_IMPORTED_MODULE_3_window___default.a.location.href = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12_Common_Links__["b" /* rootAdmin */])();
  ...
  */
	...
	AbstractApp.prototype.setClientSideToken = function setClientSideToken(token) {
		if (__WEBPACK_IMPORTED_MODULE_3_window___default.a.__rlah_set) {
			...
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12_Common_Links__["c" /* populateAuthSuffix */])();
		}
	};
  ...
  */
	...
	AbstractApp.prototype.loginAndLogoutReload = function loginAndLogoutReload() {
		...
		customLogoutLink = customLogoutLink || (admin ? __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12_Common_Links__["b" /* rootAdmin */])() : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12_Common_Links__["d" /* rootUser */])());
		...
		if (logout && __WEBPACK_IMPORTED_MODULE_3_window___default.a.location.href !== customLogoutLink) {
			...
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_20_Knoin_Knoin__["setHash"])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12_Common_Links__["a" /* root */])(), true);
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_20_Knoin_Knoin__["routeOff"])();
	...
	AbstractApp.prototype.bootstart = function bootstart() {
		...
		__WEBPACK_IMPORTED_MODULE_6_ko__["a" /* default */].components.register('SaveTrigger', __webpack_require__(/*! Component/SaveTrigger */ 109).default);
		__WEBPACK_IMPORTED_MODULE_6_ko__["a" /* default */].components.register('Input', __webpack_require__(/*! Component/Input */ 106).default);
		__WEBPACK_IMPORTED_MODULE_6_ko__["a" /* default */].components.register('Select', __webpack_require__(/*! Component/Select */ 111).default);
		__WEBPACK_IMPORTED_MODULE_6_ko__["a" /* default */].components.register('Radio', __webpack_require__(/*! Component/Radio */ 108).default);
		__WEBPACK_IMPORTED_MODULE_6_ko__["a" /* default */].components.register('TextArea', __webpack_require__(/*! Component/TextArea */ 112).default);
		__WEBPACK_IMPORTED_MODULE_6_ko__["a" /* default */].components.register('Date', __webpack_require__(/*! Component/Date */ 105).default);

		__WEBPACK_IMPORTED_MODULE_6_ko__["a" /* default */].components.register('x-script', __webpack_require__(/*! Component/Script */ 110).default);
		...
		if (__WEBPACK_IMPORTED_MODULE_16_Storage_Settings__["appSettingsGet"]('materialDesign') && __WEBPACK_IMPORTED_MODULE_9_Common_Globals__["bAnimationSupported"]) {
			__WEBPACK_IMPORTED_MODULE_6_ko__["a" /* default */].components.register('Checkbox', __webpack_require__(/*! Component/MaterialDesign/Checkbox */ 107).default);
			__WEBPACK_IMPORTED_MODULE_6_ko__["a" /* default */].components.register('CheckboxSimple', __webpack_require__(/*! Component/Checkbox */ 55).default);
		} else {
			...
			__WEBPACK_IMPORTED_MODULE_6_ko__["a" /* default */].components.register('Checkbox', __webpack_require__(/*! Component/Checkbox */ 55).default);
			__WEBPACK_IMPORTED_MODULE_6_ko__["a" /* default */].components.register('CheckboxSimple', __webpack_require__(/*! Component/Checkbox */ 55).default);
		}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_Common_Enums__ = __webpack_require__(/*! Common/Enums */ 3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_Common_Utils__ = __webpack_require__(/*! Common/Utils */ 1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_Common_Translator__ = __webpack_require__(/*! Common/Translator */ 9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_Storage_Settings__ = __webpack_require__(/*! Storage/Settings */ 10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_Stores_Theme__ = __webpack_require__(/*! Stores/Theme */ 57);
...
function cmdError(cmd) {
	return __webpack_require__(/*! Html/Cmds/Error.html */ 166).replace('{{ cmd }}', cmd);
}
...
function cmdHelp(cmds) {
	return __webpack_require__(/*! Html/Cmds/Help.html */ 167).replace('{{ commands }}', cmds.join(' '));
}
...
function cmdTheme(param, themes) {
	...
	return __webpack_require__(/*! Html/Cmds/ThemeEmpty.html */ 170).replace('{{ themes }}', themes.join(', '));
}
...
function cmdLang(param, isAdmin, langs) {
	...
	return __webpack_require__(/*! Html/Cmds/LangEmpty.html */ 168).replace('{{ langs }}', langs.join(', '));
}
 ...
 */
function cmdVersion() {
	return __webpack_require__(/*! Html/Cmds/Version.html */ 171).replace('{{ version }}', __WEBPACK_IMPORTED_MODULE_9_Storage_Settings__["appSettingsGet"]('version') + ' (' + __WEBPACK_IMPORTED_MODULE_9_Storage_Settings__["appSettingsGet"]('appVersionType') + ')');
}
...
var CmdContoller = function () {
	...
	CmdContoller.prototype.onCmd = function onCmd(isTab) {
		...
		if (isTab) {
			...
			if (h && h[0]) {
				h.append(__WEBPACK_IMPORTED_MODULE_2_____default()('<div></div>').html(__webpack_require__(/*! Html/Cmds/Main.html */ 169).replace('{{ cmd }}', cmdLine)));
				if (_result) {
...
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_Component_Abstract__["a" /* componentExportHelper */])(DateComponent, 'DateComponent'));
...
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_Component_Abstract__["a" /* componentExportHelper */])(InputComponent, 'InputComponent'));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ko__ = __webpack_require__(/*! ko */ 2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_Component_Abstract__ = __webpack_require__(/*! Component/Abstract */ 17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_Component_AbstracCheckbox__ = __webpack_require__(/*! Component/AbstracCheckbox */ 77);
...
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5_Component_Abstract__["a" /* componentExportHelper */])(CheckboxMaterialDesignComponent, 'CheckboxMaterialDesignComponent'));
...
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_Component_Abstract__["a" /* componentExportHelper */])(RadioComponent, 'RadioComponent'));
...
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5_Component_Abstract__["a" /* componentExportHelper */])(SaveTriggerComponent, 'SaveTriggerComponent'));
...
}(__WEBPACK_IMPORTED_MODULE_4_Component_Abstract__["b" /* AbstractComponent */]);

/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Component_Abstract__["a" /* componentExportHelper */])(ScriptComponent, 'ScriptComponent'));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_inherits__ = __webpack_require__(/*! babel-runtime/helpers/inherits */ 4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_inherits___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_inherits__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_Common_Translator__ = __webpack_require__(/*! Common/Translator */ 9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_Common_Utils__ = __webpack_require__(/*! Common/Utils */ 1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_Component_Abstract__ = __webpack_require__(/*! Component/Abstract */ 17);
...
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5_Component_Abstract__["a" /* componentExportHelper */])(SelectComponent, 'SelectComponent'));
...
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Component_Abstract__["a" /* componentExportHelper */])(TextAreaComponent, 'TextAreaComponent'));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3____ = __webpack_require__(/*! $ */ 12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_____default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3____);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_Common_Consts__ = __webpack_require__(/*! Common/Consts */ 19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_Common_Enums__ = __webpack_require__(/*! Common/Enums */ 3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_Common_Utils__ = __webpack_require__(/*! Common/Utils */ 1);
  ...
  */
	...
	AbstractAjaxRemote.prototype.ajaxRequest = function ajaxRequest(fResultCallback, params) {
		...
		var oDefAjax = __WEBPACK_IMPORTED_MODULE_3_____default.a.ajax({
			...
			url: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Common_Links__["h" /* ajax */])(sGetAdd),
			async: true,
			dataType: 'json',
			data: isPost ? params : {},
			headers: headers,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_Common_Utils__ = __webpack_require__(/*! Common/Utils */ 1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_Common_Links__ = __webpack_require__(/*! Common/Links */ 14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_Knoin_Knoin__ = __webpack_require__(/*! Knoin/Knoin */ 8);
  ...
  */
	...
	AbstractSettingsScreen.prototype.onRoute = function onRoute(subName) {
		...
		if (RoutedSettingsViewModel) {
			...
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9_Knoin_Knoin__["setHash"])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Common_Links__["f" /* settings */])(), false, true);
		}
	};
...
var LicenseAdminStore = function LicenseAdminStore() {
	...
	this.licensing = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false);
	this.licensingProcess = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false);
	this.licenseValid = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false);
	this.licenseExpired = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(0);
	this.licenseError = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable('');

	this.licenseTrigger = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false);
};
...
var PackageAdminStore = function PackageAdminStore() {
	...
	this.packages = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observableArray([]);
	this.packages.loading = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false).extend({ throttle: 100 });

	this.packagesReal = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(true);
	this.packagesMainUpdatable = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(true);
};
...
var PluginAdminStore = function PluginAdminStore() {
	...
	this.plugins = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observableArray([]);
	this.plugins.loading = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false).extend({ throttle: 100 });
	this.plugins.error = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable('');
};
...
module.exports = { "default": __webpack_require__(/*! core-js/library/fn/symbol/iterator */ 134), __esModule: true };
...
__webpack_require__(/*! ../../modules/es6.object.get-own-property-descriptor */ 157);
var $Object = __webpack_require__(/*! ../../modules/_core */ 25).Object;
...
__webpack_require__(/*! ../../modules/es6.symbol */ 161);
__webpack_require__(/*! ../../modules/es6.object.to-string */ 159);
__webpack_require__(/*! ../../modules/es7.symbol.async-iterator */ 162);
__webpack_require__(/*! ../../modules/es7.symbol.observable */ 163);
...
__webpack_require__(/*! ../../modules/web.dom.iterable */ 164);
...
var toIObject = __webpack_require__(/*! ./_to-iobject */ 23)
  , toLength  = __webpack_require__(/*! ./_to-length */ 153)
  , toIndex   = __webpack_require__(/*! ./_to-index */ 152);
...
var META     = __webpack_require__(/*! ./_uid */ 52)('meta')
  , isObject = __webpack_require__(/*! ./_is-object */ 45)
  , has      = __webpack_require__(/*! ./_has */ 26)
...
var has         = __webpack_require__(/*! ./_has */ 26)
  , toObject    = __webpack_require__(/*! ./_to-object */ 154)
  , IE_PROTO    = __webpack_require__(/*! ./_shared-key */ 66)('IE_PROTO')
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function(test, buggy, set){
      try {
        set = __webpack_require__(/*! ./_ctx */ 83)(Function.call, __webpack_require__(/*! ./_object-gopd */ 63).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var addToUnscopables = __webpack_require__(/*! ./_add-to-unscopables */ 136)
  , step             = __webpack_require__(/*! ./_iter-step */ 143)
  , Iterators        = __webpack_require__(/*! ./_iterators */ 60)
  , toIObject        = __webpack_require__(/*! ./_to-iobject */ 23);
...
var toIObject                 = __webpack_require__(/*! ./_to-iobject */ 23)
  , $getOwnPropertyDescriptor = __webpack_require__(/*! ./_object-gopd */ 63).f;
...
var $at  = __webpack_require__(/*! ./_string-at */ 151)(true);
...
var global         = __webpack_require__(/*! ./_global */ 22)
  ...
  , $export        = __webpack_require__(/*! ./_export */ 43)
  , redefine       = __webpack_require__(/*! ./_redefine */ 90)
  , META           = __webpack_require__(/*! ./_meta */ 145).KEY
  , $fails         = __webpack_require__(/*! ./_fails */ 44)
  ...
  , gOPNExt        = __webpack_require__(/*! ./_object-gopn-ext */ 147)
  , $GOPD          = __webpack_require__(/*! ./_object-gopd */ 63)
...
__webpack_require__(/*! ./es6.array.iterator */ 155);
var global        = __webpack_require__(/*! ./_global */ 22)
  , hide          = __webpack_require__(/*! ./_hide */ 32)
  , Iterators     = __webpack_require__(/*! ./_iterators */ 60)
...
(function (root, factory)
{
    ...
    if (true) {
        ...
        try { moment = __webpack_require__(/*! moment */ 72); } catch (e) {}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_Stores_Admin_App__ = __webpack_require__(/*! Stores/Admin/App */ 56);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_Stores_Admin_Plugin__ = __webpack_require__(/*! Stores/Admin/Plugin */ 120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_Stores_Admin_License__ = __webpack_require__(/*! Stores/Admin/License */ 118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_Stores_Admin_Package__ = __webpack_require__(/*! Stores/Admin/Package */ 119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18_Stores_Admin_Core__ = __webpack_require__(/*! Stores/Admin/Core */ 183);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19_Remote_Admin_Ajax__ = __webpack_require__(/*! Remote/Admin/Ajax */ 21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20_Screen_Admin_Settings__ = __webpack_require__(/*! Screen/Admin/Settings */ 217);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21_Screen_Admin_Login__ = __webpack_require__(/*! Screen/Admin/Login */ 216);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22_Knoin_Knoin__ = __webpack_require__(/*! Knoin/Knoin */ 8);
		...
		__WEBPACK_IMPORTED_MODULE_19_Remote_Admin_Ajax__["a" /* default */].domainList(function (result, data) {
			...
			if (__WEBPACK_IMPORTED_MODULE_9_Common_Enums__["StorageResultType"].Success === result && data && data.Result) {
				__WEBPACK_IMPORTED_MODULE_14_Stores_Admin_Domain__["a" /* default */].domains(__WEBPACK_IMPORTED_MODULE_4_____default.a.map(data.Result, function (_ref, name) {
					...
					return {
						name: name,
						disabled: __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(!enabled),
						alias: alias,
						deleteAccess: __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(false)
					};
				}));
			}
		});
		...
		__WEBPACK_IMPORTED_MODULE_19_Remote_Admin_Ajax__["a" /* default */].pluginList(function (result, data) {
			...
			if (__WEBPACK_IMPORTED_MODULE_9_Common_Enums__["StorageResultType"].Success === result && data && data.Result) {
				__WEBPACK_IMPORTED_MODULE_15_Stores_Admin_Plugin__["a" /* default */].plugins(__WEBPACK_IMPORTED_MODULE_4_____default.a.map(data.Result, function (item) {
					return {
						name: item.Name,
						disabled: __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(!item.Enabled),
						configured: __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(!!item.Configured)
					};
				}));
			}
		});
			...
			if (__WEBPACK_IMPORTED_MODULE_9_Common_Enums__["StorageResultType"].Success === result && data && data.Result) {
				...
				if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_10_Common_Utils__["isArray"])(data.Result.List)) {
					list = __WEBPACK_IMPORTED_MODULE_4_____default.a.compact(__WEBPACK_IMPORTED_MODULE_4_____default.a.map(data.Result.List, function (item) {
						if (item) {
							item.loading = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_10_Common_Utils__["isUnd"])(loading[item.file]));
  ...
  */
	...
	AdminApp.prototype.bootstart = function bootstart() {
		...
		if (!__WEBPACK_IMPORTED_MODULE_11_Storage_Settings__["appSettingsGet"]('allowAdminPanel')) {
			...
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_22_Knoin_Knoin__["setHash"])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_Common_Links__["a" /* root */])(), true);
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_22_Knoin_Knoin__["routeOff"])();
...
var CoreAdminStore = function CoreAdminStore() {
	...
	this.coreReal = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(true);
	this.coreChannel = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable('stable');
	this.coreType = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable('stable');
	this.coreUpdatable = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(true);
	this.coreAccess = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(true);
	this.coreWarning = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false);
	this.coreChecking = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false).extend({ throttle: 100 });
	this.coreUpdating = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(false).extend({ throttle: 100 });
	this.coreVersion = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable('');
	this.coreRemoteVersion = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable('');
	this.coreRemoteRelease = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable('');
	this.coreVersionCompare = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(-2);
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_Common_Enums__ = __webpack_require__(/*! Common/Enums */ 3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_Common_Utils__ = __webpack_require__(/*! Common/Utils */ 1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_Common_Consts__ = __webpack_require__(/*! Common/Consts */ 19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_Common_Translator__ = __webpack_require__(/*! Common/Translator */ 9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_Storage_Settings__ = __webpack_require__(/*! Storage/Settings */ 10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_Remote_Admin_Ajax__ = __webpack_require__(/*! Remote/Admin/Ajax */ 21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_Stores_Admin_License__ = __webpack_require__(/*! Stores/Admin/License */ 118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_Knoin_Knoin__ = __webpack_require__(/*! Knoin/Knoin */ 8);
...
var ActivatePopupView = (_dec = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12_Knoin_Knoin__["popup"])({
	...
	__WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_inherits___default()(ActivatePopupView, _AbstractViewNext);

	function ActivatePopupView() {
		__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck___default()(this, ActivatePopupView);
		...
		_this.domain = __WEBPACK_IMPORTED_MODULE_4_ko__["a" /* default */].observable('');
		...
		_this.activationSuccessed = __WEBPACK_IMPORTED_MODULE_4_ko__["a" /* default */].observable(false);

		_this.licenseTrigger = __WEBPACK_IMPORTED_MODULE_11_Stores_Admin_License__["a" /* default */].licenseTrigger;

		_this.activateProcess = __WEBPACK_IMPORTED_MODULE_4_ko__["a" /* default */].observable(false);
		_this.activateText = __WEBPACK_IMPORTED_MODULE_4_ko__["a" /* default */].observable('');
		_this.activateText.isError = __WEBPACK_IMPORTED_MODULE_4_ko__["a" /* default */].observable(false);

		_this.htmlDescription = __WEBPACK_IMPORTED_MODULE_4_ko__["a" /* default */].computed(function () {
			return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Common_Translator__["i18n"])('POPUPS_ACTIVATE/HTML_DESC', { 'DOMAIN': _this.domain() });
		});
	...
	ActivatePopupView.prototype.activateCommand = function activateCommand() {
		var _this2 = this;

		this.activateProcess(true);
		if (this.validateSubscriptionKey()) {
			__WEBPACK_IMPORTED_MODULE_10_Remote_Admin_Ajax__["a" /* default */].licensingActivate(function (sResult, oData) {

				_this2.activateProcess(false);
				if (__WEBPACK_IMPORTED_MODULE_5_Common_Enums__["StorageResultType"].Success === sResult && oData.Result) {
					if (true === oData.Result) {
						_this2.activationSuccessed(true);
						_this2.activateText(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Common_Translator__["i18n"])('POPUPS_ACTIVATE/SUBS_KEY_ACTIVATED'));
					...
					_this2.activateText(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Common_Translator__["getNotification"])(oData.ErrorCode));
					_this2.activateText.isError(true);
					_this2.key.focus(true);
				} else {
					_this2.activateText(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Common_Translator__["getNotification"])(__WEBPACK_IMPORTED_MODULE_5_Common_Enums__["Notification"].UnknownError));
					_this2.activateText.isError(true);
					_this2.key.focus(true);
				}
			...
			this.activateText(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Common_Translator__["i18n"])('POPUPS_ACTIVATE/ERROR_INVALID_SUBS_KEY'));
			this.activateText.isError(true);
			this.key.focus(true);
		}
	};

	ActivatePopupView.prototype.onShow = function onShow(isTrial) {
		this.domain(__WEBPACK_IMPORTED_MODULE_9_Storage_Settings__["settingsGet"]('AdminDomain'));
		if (!this.activateProcess()) {
			isTrial = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6_Common_Utils__["isUnd"])(isTrial) ? false : !!isTrial;

			this.key(isTrial ? __WEBPACK_IMPORTED_MODULE_7_Common_Consts__["a" /* RAINLOOP_TRIAL_KEY */] : '');
			this.activateText('');
	...
	ActivatePopupView.prototype.onShowWithDelay = function onShowWithDelay() {
		if (!this.activateProcess()) {
			this.key.focus(true);
		}
	};
  ...
  */
	...
	ActivatePopupView.prototype.validateSubscriptionKey = function validateSubscriptionKey() {
		var value = this.key();
		return '' === value || __WEBPACK_IMPORTED_MODULE_7_Common_Consts__["a" /* RAINLOOP_TRIAL_KEY */] === value || !!/^RL[\d]+-[A-Z0-9\-]+Z$/.test(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6_Common_Utils__["trim"])(value).replace(/[^A-Z0-9\-]/gi, ''));
	};

	return ActivatePopupView;
}(__WEBPACK_IMPORTED_MODULE_13_Knoin_AbstractViewNext__["a" /* AbstractViewNext */]), (_applyDecoratedDescriptor(_class2.prototype, 'activateCommand', [_dec2], __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_get_own_property_descriptor___default()(_class2.prototype, 'activateCommand'), _class2.prototype)), _class2)) || _class);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_Common_Translator__ = __webpack_require__(/*! Common/Translator */ 9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_Stores_Admin_Capa__ = __webpack_require__(/*! Stores/Admin/Capa */ 95);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_Remote_Admin_Ajax__ = __webpack_require__(/*! Remote/Admin/Ajax */ 21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_Helper_Apps_Admin__ = __webpack_require__(/*! Helper/Apps/Admin */ 38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_Knoin_Knoin__ = __webpack_require__(/*! Knoin/Knoin */ 8);
...
var DomainPopupView = (_dec = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_14_Knoin_Knoin__["popup"])({
	...
	function DomainPopupView() {
		...
		_this.edit = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(false);
		_this.saving = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(false);
		_this.savingError = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('');
		_this.page = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('main');
		_this.sieveSettings = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(false);

		_this.testing = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(false);
		_this.testingDone = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(false);
		_this.testingImapError = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(false);
		_this.testingSieveError = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(false);
		_this.testingSmtpError = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(false);
		_this.testingImapErrorDesc = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('');
		_this.testingSieveErrorDesc = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('');
		_this.testingSmtpErrorDesc = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('');
		...
		_this.imapServerFocus = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(false);
		_this.sieveServerFocus = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(false);
		_this.smtpServerFocus = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(false);

		_this.name = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('');
		_this.name.focused = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(false);

		_this.imapServer = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('');
		_this.imapPort = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('' + __WEBPACK_IMPORTED_MODULE_7_Common_Consts__["b" /* IMAP_DEFAULT_PORT */]);
		_this.imapSecure = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_6_Common_Enums__["ServerSecure"].None);
		_this.imapShortLogin = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(false);
		_this.useSieve = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(false);
		_this.sieveAllowRaw = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(false);
		_this.sieveServer = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('');
		_this.sievePort = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('' + __WEBPACK_IMPORTED_MODULE_7_Common_Consts__["c" /* SIEVE_DEFAULT_PORT */]);
		_this.sieveSecure = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_6_Common_Enums__["ServerSecure"].None);
		_this.smtpServer = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('');
		_this.smtpPort = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('' + __WEBPACK_IMPORTED_MODULE_7_Common_Consts__["d" /* SMTP_DEFAULT_PORT */]);
		_this.smtpSecure = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_6_Common_Enums__["ServerSecure"].None);
		_this.smtpShortLogin = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(false);
		_this.smtpAuth = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(true);
		_this.smtpPhpMail = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(false);
		_this.whiteList = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('');
		_this.aliasName = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('');

		_this.enableSmartPorts = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(false);

		_this.allowSieve = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].computed(function () {
		...
		_this.headerText = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].computed(function () {
		...
		_this.domainDesc = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].computed(function () {
			var name = _this.name();
		...
		_this.domainIsComputed = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].computed(function () {
		...
		_this.canBeTested = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].computed(function () {
			return !_this.testing() && _this.domainIsComputed();
		});
		_this.canBeSaved = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].computed(function () {
	...
	DomainPopupView.prototype.clearForm = function clearForm() {
		...
		this.imapServer('');
		this.imapPort('' + __WEBPACK_IMPORTED_MODULE_7_Common_Consts__["b" /* IMAP_DEFAULT_PORT */]);
		...
		this.sieveServer('');
		this.sievePort('' + __WEBPACK_IMPORTED_MODULE_7_Common_Consts__["c" /* SIEVE_DEFAULT_PORT */]);
		this.sieveSecure(__WEBPACK_IMPORTED_MODULE_6_Common_Enums__["ServerSecure"].None);

		this.smtpServer('');
		this.smtpPort('' + __WEBPACK_IMPORTED_MODULE_7_Common_Consts__["d" /* SMTP_DEFAULT_PORT */]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_Helper_Apps_Admin__ = __webpack_require__(/*! Helper/Apps/Admin */ 38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_View_Admin_Login__ = __webpack_require__(/*! View/Admin/Login */ 244);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_inherits__ = __webpack_require__(/*! babel-runtime/helpers/inherits */ 4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_inherits___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_inherits__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_Knoin_Knoin__ = __webpack_require__(/*! Knoin/Knoin */ 8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_Common_Plugins__ = __webpack_require__(/*! Common/Plugins */ 27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_Screen_AbstractSettings__ = __webpack_require__(/*! Screen/AbstractSettings */ 116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_Settings_Admin_General__ = __webpack_require__(/*! Settings/Admin/General */ 225);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_Settings_Admin_Login__ = __webpack_require__(/*! Settings/Admin/Login */ 226);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_Settings_Admin_Contacts__ = __webpack_require__(/*! Settings/Admin/Contacts */ 223);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_Settings_Admin_Domains__ = __webpack_require__(/*! Settings/Admin/Domains */ 224);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_Settings_Admin_Security__ = __webpack_require__(/*! Settings/Admin/Security */ 231);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_Settings_Admin_Social__ = __webpack_require__(/*! Settings/Admin/Social */ 232);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_Settings_Admin_Plugins__ = __webpack_require__(/*! Settings/Admin/Plugins */ 228);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_Settings_Admin_Packages__ = __webpack_require__(/*! Settings/Admin/Packages */ 227);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_Settings_Admin_About__ = __webpack_require__(/*! Settings/Admin/About */ 221);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_Helper_Apps_Admin__ = __webpack_require__(/*! Helper/Apps/Admin */ 38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_View_Admin_Settings_Menu__ = __webpack_require__(/*! View/Admin/Settings/Menu */ 245);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_View_Admin_Settings_Pane__ = __webpack_require__(/*! View/Admin/Settings/Pane */ 246);
...
var SettingsAdminScreen = function (_AbstractSettingsScre) {
  ...
  */
	...
	SettingsAdminScreen.prototype.setupSettings = function setupSettings() {
		...
		if (false) {
			addSettingsViewModel(require('Settings/Admin/Branding').default, 'AdminSettingsBranding', 'TABS_LABELS/LABEL_BRANDING_NAME', 'branding');
		} else {
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_Knoin_Knoin__["addSettingsViewModel"])(__webpack_require__(/*! Settings/Admin/Prem/Branding */ 229).default, 'AdminSettingsBranding', 'TABS_LABELS/LABEL_BRANDING_NAME', 'branding');
		}
		...
		if (true) {
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_Knoin_Knoin__["addSettingsViewModel"])(__webpack_require__(/*! Settings/Admin/Prem/Licensing */ 230).default, 'AdminSettingsLicensing', 'TABS_LABELS/LABEL_LICENSING_NAME', 'licensing');
		}
		...
		__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Plugins__["b" /* runSettingsViewModelHooks */])(true);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ko__ = __webpack_require__(/*! ko */ 2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_Common_Translator__ = __webpack_require__(/*! Common/Translator */ 9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_Storage_Settings__ = __webpack_require__(/*! Storage/Settings */ 10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_Stores_Admin_App__ = __webpack_require__(/*! Stores/Admin/App */ 56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_Stores_Admin_Core__ = __webpack_require__(/*! Stores/Admin/Core */ 183);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_Helper_Apps_Admin__ = __webpack_require__(/*! Helper/Apps/Admin */ 38);
...
var AboutAdminSettings = function () {
	function AboutAdminSettings() {
		...
		this.version = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_Storage_Settings__["appSettingsGet"])('version'));
		this.access = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(!!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_Storage_Settings__["settingsGet"])('CoreAccess'));
		this.errorDesc = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable('');
		...
		this.community = false || __WEBPACK_IMPORTED_MODULE_4_Stores_Admin_App__["a" /* default */].community();

		this.coreRemoteVersionHtmlDesc = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].computed(function () {
		...
		this.statusType = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].computed(function () {
			var type = '';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_Common_Utils__ = __webpack_require__(/*! Common/Utils */ 1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_Common_Translator__ = __webpack_require__(/*! Common/Translator */ 9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_Remote_Admin_Ajax__ = __webpack_require__(/*! Remote/Admin/Ajax */ 21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_Stores_Admin_App__ = __webpack_require__(/*! Stores/Admin/App */ 56);
...
var BrandingAdminSettings = function () {
	function BrandingAdminSettings() {
		...
		this.title = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Storage_Settings__["settingsGet"])('Title')).idleTrigger();
		this.loadingDesc = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Storage_Settings__["settingsGet"])('LoadingDescription')).idleTrigger();
		this.faviconUrl = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Storage_Settings__["settingsGet"])('FaviconUrl')).idleTrigger();
		this.loginLogo = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Storage_Settings__["settingsGet"])('LoginLogo') || '').idleTrigger();
		this.loginBackground = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Storage_Settings__["settingsGet"])('LoginBackground') || '').idleTrigger();
		this.userLogo = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Storage_Settings__["settingsGet"])('UserLogo') || '').idleTrigger();
		this.userLogoMessage = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Storage_Settings__["settingsGet"])('UserLogoMessage') || '').idleTrigger();
		this.userIframeMessage = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Storage_Settings__["settingsGet"])('UserIframeMessage') || '').idleTrigger();
		this.userLogoTitle = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Storage_Settings__["settingsGet"])('UserLogoTitle') || '').idleTrigger();
		this.loginDescription = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Storage_Settings__["settingsGet"])('LoginDescription')).idleTrigger();
		this.loginCss = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Storage_Settings__["settingsGet"])('LoginCss')).idleTrigger();
		this.userCss = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Storage_Settings__["settingsGet"])('UserCss')).idleTrigger();
		this.welcomePageUrl = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Storage_Settings__["settingsGet"])('WelcomePageUrl')).idleTrigger();
		this.welcomePageDisplay = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Storage_Settings__["settingsGet"])('WelcomePageDisplay')).idleTrigger();
		this.welcomePageDisplay.options = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].computed(function () {
		...
		this.loginPowered = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(!!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Storage_Settings__["settingsGet"])('LoginPowered'));
		this.community = false || __WEBPACK_IMPORTED_MODULE_7_Stores_Admin_App__["a" /* default */].community();
	}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_Common_Utils__ = __webpack_require__(/*! Common/Utils */ 1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_Common_Enums__ = __webpack_require__(/*! Common/Enums */ 3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_Common_Translator__ = __webpack_require__(/*! Common/Translator */ 9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_Storage_Settings__ = __webpack_require__(/*! Storage/Settings */ 10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_Remote_Admin_Ajax__ = __webpack_require__(/*! Remote/Admin/Ajax */ 21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_Knoin_Knoin__ = __webpack_require__(/*! Knoin/Knoin */ 8);
...
var ContactsAdminSettings = (_dec = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9_Knoin_Knoin__["command"])(function (self) {
	...
	function ContactsAdminSettings() {
		...
		this.enableContacts = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(!!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_Storage_Settings__["settingsGet"])('ContactsEnable'));
		this.contactsSharing = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(!!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_Storage_Settings__["settingsGet"])('ContactsSharing'));
		this.contactsSync = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(!!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_Storage_Settings__["settingsGet"])('ContactsSync'));
		...
		this.contactsTypes = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observableArray([]);
		...
		this.contactsType = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable('');

		this.mainContactsType = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].computed({
		...
		this.pdoDsn = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_Storage_Settings__["settingsGet"])('ContactsPdoDsn'));
		this.pdoUser = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_Storage_Settings__["settingsGet"])('ContactsPdoUser'));
		this.pdoPassword = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_Storage_Settings__["settingsGet"])('ContactsPdoPassword'));

		this.pdoDsnTrigger = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_5_Common_Enums__["SaveSettingsStep"].Idle);
		this.pdoUserTrigger = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_5_Common_Enums__["SaveSettingsStep"].Idle);
		this.pdoPasswordTrigger = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_5_Common_Enums__["SaveSettingsStep"].Idle);
		this.contactsTypeTrigger = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_5_Common_Enums__["SaveSettingsStep"].Idle);

		this.testing = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(false);
		this.testContactsSuccess = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(false);
		this.testContactsError = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(false);
		this.testContactsErrorMessage = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable('');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ko__ = __webpack_require__(/*! ko */ 2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_Common_Enums__ = __webpack_require__(/*! Common/Enums */ 3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_Knoin_Knoin__ = __webpack_require__(/*! Knoin/Knoin */ 8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_Stores_Admin_Domain__ = __webpack_require__(/*! Stores/Admin/Domain */ 96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_Remote_Admin_Ajax__ = __webpack_require__(/*! Remote/Admin/Ajax */ 21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_Helper_Apps_Admin__ = __webpack_require__(/*! Helper/Apps/Admin */ 38);
...
var DomainsAdminSettings = function () {
	function DomainsAdminSettings() {
		...
		this.visibility = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].computed(function () {
			return _this.domains.loading() ? 'visible' : 'hidden';
		});

		this.domainForDeletion = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(null).deleteAccessHelper();
	...
	DomainsAdminSettings.prototype.createDomain = function createDomain() {
		__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Knoin_Knoin__["showScreenPopup"])(__webpack_require__(/*! View/Popup/Domain */ 188));
	};

	DomainsAdminSettings.prototype.createDomainAlias = function createDomainAlias() {
		__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Knoin_Knoin__["showScreenPopup"])(__webpack_require__(/*! View/Popup/DomainAlias */ 250));
	};
	...
	DomainsAdminSettings.prototype.onBuild = function onBuild(oDom) {
		...
		oDom.on('click', '.b-admin-domains-list-table .e-item .e-action', function () {
			...
			var domainItem = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].dataFor(this); // eslint-disable-line no-invalid-this
			if (domainItem) {
	...
	DomainsAdminSettings.prototype.onDomainLoadRequest = function onDomainLoadRequest(sResult, oData) {
		if (__WEBPACK_IMPORTED_MODULE_3_Common_Enums__["StorageResultType"].Success === sResult && oData && oData.Result) {
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Knoin_Knoin__["showScreenPopup"])(__webpack_require__(/*! View/Popup/Domain */ 188), [oData.Result]);
		}
	};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_Storage_Settings__ = __webpack_require__(/*! Storage/Settings */ 10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_Knoin_Knoin__ = __webpack_require__(/*! Knoin/Knoin */ 8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_Remote_Admin_Ajax__ = __webpack_require__(/*! Remote/Admin/Ajax */ 21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_Stores_Theme__ = __webpack_require__(/*! Stores/Theme */ 57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_Stores_Language__ = __webpack_require__(/*! Stores/Language */ 53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_Stores_Admin_App__ = __webpack_require__(/*! Stores/Admin/App */ 56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_Stores_Admin_Capa__ = __webpack_require__(/*! Stores/Admin/Capa */ 95);
...
var GeneralAdminSettings = function () {
	function GeneralAdminSettings() {
		...
		this.themesOptions = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].computed(function () {
		...
		this.languageAdminFullName = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].computed(function () {
			return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_Common_Utils__["convertLangName"])(_this.languageAdmin());
		});

		this.attachmentLimitTrigger = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_4_Common_Enums__["SaveSettingsStep"].Idle);
		this.languageTrigger = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_4_Common_Enums__["SaveSettingsStep"].Idle);
		this.languageAdminTrigger = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_4_Common_Enums__["SaveSettingsStep"].Idle).extend({ throttle: __WEBPACK_IMPORTED_MODULE_4_Common_Enums__["Magics"].Time100ms });
		this.themeTrigger = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_4_Common_Enums__["SaveSettingsStep"].Idle);
	}
	...
	GeneralAdminSettings.prototype.onBuild = function onBuild() {
		...
		__WEBPACK_IMPORTED_MODULE_1_____default.a.delay(function () {
			...
			_this2.newMoveToFolder.subscribe(function (value) {
				__WEBPACK_IMPORTED_MODULE_9_Remote_Admin_Ajax__["a" /* default */].saveAdminConfig(null, {
					'NewMoveToFolder': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_Common_Utils__["boolToAjax"])(value)
				});
			});
	...
	GeneralAdminSettings.prototype.selectLanguage = function selectLanguage() {
		__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Knoin_Knoin__["showScreenPopup"])(__webpack_require__(/*! View/Popup/Languages */ 80), [this.language, this.languages(), __WEBPACK_IMPORTED_MODULE_11_Stores_Language__["a" /* default */].userLanguage()]);
	};

	GeneralAdminSettings.prototype.selectLanguageAdmin = function selectLanguageAdmin() {
		__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Knoin_Knoin__["showScreenPopup"])(__webpack_require__(/*! View/Popup/Languages */ 80), [this.languageAdmin, this.languagesAdmin(), __WEBPACK_IMPORTED_MODULE_11_Stores_Language__["a" /* default */].userLanguageAdmin()]);
	};
  ...
  */
	...
	GeneralAdminSettings.prototype.phpInfoLink = function phpInfoLink() {
		return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6_Common_Links__["g" /* phpInfo */])();
	};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_Common_Utils__ = __webpack_require__(/*! Common/Utils */ 1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_Storage_Settings__ = __webpack_require__(/*! Storage/Settings */ 10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_Stores_Admin_App__ = __webpack_require__(/*! Stores/Admin/App */ 56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_Remote_Admin_Ajax__ = __webpack_require__(/*! Remote/Admin/Ajax */ 21);
...
var LoginAdminSettings = function () {
	function LoginAdminSettings() {
		...
		this.defaultDomain = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Storage_Settings__["settingsGet"])('LoginDefaultDomain')).idleTrigger();
		this.allowLanguagesOnLogin = __WEBPACK_IMPORTED_MODULE_5_Stores_Admin_App__["a" /* default */].allowLanguagesOnLogin;

		this.dummy = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(false);
	}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_Common_Enums__ = __webpack_require__(/*! Common/Enums */ 3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_Common_Translator__ = __webpack_require__(/*! Common/Translator */ 9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_Stores_Admin_Package__ = __webpack_require__(/*! Stores/Admin/Package */ 119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_Remote_Admin_Ajax__ = __webpack_require__(/*! Remote/Admin/Ajax */ 21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_Helper_Apps_Admin__ = __webpack_require__(/*! Helper/Apps/Admin */ 38);
...
var PackagesAdminSettings = function () {
	function PackagesAdminSettings() {
		...
		this.packagesError = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable('');
		...
		this.visibility = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].computed(function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_Common_Utils__ = __webpack_require__(/*! Common/Utils */ 1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_Storage_Settings__ = __webpack_require__(/*! Storage/Settings */ 10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_Knoin_Knoin__ = __webpack_require__(/*! Knoin/Knoin */ 8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_Stores_Admin_App__ = __webpack_require__(/*! Stores/Admin/App */ 56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_Stores_Admin_Plugin__ = __webpack_require__(/*! Stores/Admin/Plugin */ 120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_Remote_Admin_Ajax__ = __webpack_require__(/*! Remote/Admin/Ajax */ 21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_Helper_Apps_Admin__ = __webpack_require__(/*! Helper/Apps/Admin */ 38);
...
var PluginsAdminSettings = function () {
	function PluginsAdminSettings() {
		...
		this.enabledPlugins = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(!!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6_Storage_Settings__["settingsGet"])('EnabledPlugins'));
		...
		this.community = false || __WEBPACK_IMPORTED_MODULE_8_Stores_Admin_App__["a" /* default */].community();
	...
	PluginsAdminSettings.prototype.onBuild = function onBuild(oDom) {
		...
		oDom.on('click', '.e-item .configure-plugin-action', function () {
			// eslint-disable-line prefer-arrow-callback
			var plugin = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].dataFor(this); // eslint-disable-line no-invalid-this
			if (plugin) {
	...
	PluginsAdminSettings.prototype.onPluginLoadRequest = function onPluginLoadRequest(result, data) {
		if (__WEBPACK_IMPORTED_MODULE_3_Common_Enums__["StorageResultType"].Success === result && data && data.Result) {
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_Knoin_Knoin__["showScreenPopup"])(__webpack_require__(/*! View/Popup/Plugin */ 254), [data.Result]);
		}
	};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_Common_Enums__ = __webpack_require__(/*! Common/Enums */ 3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_Remote_Admin_Ajax__ = __webpack_require__(/*! Remote/Admin/Ajax */ 21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_Settings_Admin_Branding__ = __webpack_require__(/*! Settings/Admin/Branding */ 222);
...
var BrandingPremAdminSettings = function (_BrandingAdminSetting) {
	__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_inherits___default()(BrandingPremAdminSettings, _BrandingAdminSetting);

	function BrandingPremAdminSettings() {
		__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, BrandingPremAdminSettings);

		return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_possibleConstructorReturn___default()(this, _BrandingAdminSetting.apply(this, arguments));
	}

	BrandingPremAdminSettings.prototype.onBuild = function onBuild(dom) {
		var _this2 = this;
		...
		if (this.capa && this.capa() && !this.community) {
			__WEBPACK_IMPORTED_MODULE_3_____default.a.delay(function () {
				...
				var f1 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["settingsSaveHelperSimpleFunction"])(_this2.loginLogo.trigger, _this2),
				    f2 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["settingsSaveHelperSimpleFunction"])(_this2.loginDescription.trigger, _this2),
				    f3 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["settingsSaveHelperSimpleFunction"])(_this2.loginCss.trigger, _this2),
				    f4 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["settingsSaveHelperSimpleFunction"])(_this2.userLogo.trigger, _this2),
				    f5 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["settingsSaveHelperSimpleFunction"])(_this2.userLogoTitle.trigger, _this2),
				    f6 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["settingsSaveHelperSimpleFunction"])(_this2.loginBackground.trigger, _this2),
				    f7 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["settingsSaveHelperSimpleFunction"])(_this2.userCss.trigger, _this2),
				    f8 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["settingsSaveHelperSimpleFunction"])(_this2.welcomePageUrl.trigger, _this2),
				    f9 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["settingsSaveHelperSimpleFunction"])(_this2.welcomePageDisplay.trigger, _this2),
				    f10 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["settingsSaveHelperSimpleFunction"])(_this2.userLogoMessage.trigger, _this2),
				    f11 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["settingsSaveHelperSimpleFunction"])(_this2.userIframeMessage.trigger, _this2);

				_this2.loginLogo.subscribe(function (value) {
					__WEBPACK_IMPORTED_MODULE_6_Remote_Admin_Ajax__["a" /* default */].saveAdminConfig(f1, {
						'LoginLogo': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["trim"])(value)
					});
				});

				_this2.loginDescription.subscribe(function (value) {
					__WEBPACK_IMPORTED_MODULE_6_Remote_Admin_Ajax__["a" /* default */].saveAdminConfig(f2, {
						'LoginDescription': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["trim"])(value)
					});
				});

				_this2.loginCss.subscribe(function (value) {
					__WEBPACK_IMPORTED_MODULE_6_Remote_Admin_Ajax__["a" /* default */].saveAdminConfig(f3, {
						'LoginCss': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["trim"])(value)
					});
				});

				_this2.userLogo.subscribe(function (value) {
					__WEBPACK_IMPORTED_MODULE_6_Remote_Admin_Ajax__["a" /* default */].saveAdminConfig(f4, {
						'UserLogo': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["trim"])(value)
					});
				});

				_this2.userLogoTitle.subscribe(function (value) {
					__WEBPACK_IMPORTED_MODULE_6_Remote_Admin_Ajax__["a" /* default */].saveAdminConfig(f5, {
						'UserLogoTitle': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["trim"])(value)
					});
				});

				_this2.userLogoMessage.subscribe(function (value) {
					__WEBPACK_IMPORTED_MODULE_6_Remote_Admin_Ajax__["a" /* default */].saveAdminConfig(f10, {
						'UserLogoMessage': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["trim"])(value)
					});
				});

				_this2.userIframeMessage.subscribe(function (value) {
					__WEBPACK_IMPORTED_MODULE_6_Remote_Admin_Ajax__["a" /* default */].saveAdminConfig(f11, {
						'UserIframeMessage': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["trim"])(value)
					});
				});

				_this2.loginBackground.subscribe(function (value) {
					__WEBPACK_IMPORTED_MODULE_6_Remote_Admin_Ajax__["a" /* default */].saveAdminConfig(f6, {
						'LoginBackground': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["trim"])(value)
					});
				});

				_this2.userCss.subscribe(function (value) {
					__WEBPACK_IMPORTED_MODULE_6_Remote_Admin_Ajax__["a" /* default */].saveAdminConfig(f7, {
						'UserCss': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["trim"])(value)
					});
				});

				_this2.welcomePageUrl.subscribe(function (value) {
					__WEBPACK_IMPORTED_MODULE_6_Remote_Admin_Ajax__["a" /* default */].saveAdminConfig(f8, {
						'WelcomePageUrl': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["trim"])(value)
					});
				});

				_this2.welcomePageDisplay.subscribe(function (value) {
					__WEBPACK_IMPORTED_MODULE_6_Remote_Admin_Ajax__["a" /* default */].saveAdminConfig(f9, {
						'WelcomePageDisplay': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["trim"])(value)
					});
				});

				_this2.loginPowered.subscribe(function (value) {
					__WEBPACK_IMPORTED_MODULE_6_Remote_Admin_Ajax__["a" /* default */].saveAdminConfig(null, {
						'LoginPowered': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Common_Utils__["boolToAjax"])(value)
					});
				});
			}, __WEBPACK_IMPORTED_MODULE_5_Common_Enums__["Magics"].Time50ms);
		}
...
}(__WEBPACK_IMPORTED_MODULE_7_Settings_Admin_Branding__["a" /* BrandingAdminSettings */]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ko__ = __webpack_require__(/*! ko */ 2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_moment__ = __webpack_require__(/*! moment */ 72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_Storage_Settings__ = __webpack_require__(/*! Storage/Settings */ 10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_Knoin_Knoin__ = __webpack_require__(/*! Knoin/Knoin */ 8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_Stores_Admin_License__ = __webpack_require__(/*! Stores/Admin/License */ 118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_Helper_Apps_Admin__ = __webpack_require__(/*! Helper/Apps/Admin */ 38);
...
var LicensingPremAdminSettings = function () {
	function LicensingPremAdminSettings() {
		var _this = this;

		__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, LicensingPremAdminSettings);

		this.licensing = __WEBPACK_IMPORTED_MODULE_5_Stores_Admin_License__["a" /* default */].licensing;
		this.licensingProcess = __WEBPACK_IMPORTED_MODULE_5_Stores_Admin_License__["a" /* default */].licensingProcess;
		this.licenseValid = __WEBPACK_IMPORTED_MODULE_5_Stores_Admin_License__["a" /* default */].licenseValid;
		this.licenseExpired = __WEBPACK_IMPORTED_MODULE_5_Stores_Admin_License__["a" /* default */].licenseExpired;
		this.licenseError = __WEBPACK_IMPORTED_MODULE_5_Stores_Admin_License__["a" /* default */].licenseError;
		this.licenseTrigger = __WEBPACK_IMPORTED_MODULE_5_Stores_Admin_License__["a" /* default */].licenseTrigger;

		this.adminDomain = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable('');
		this.subscriptionEnabled = __WEBPACK_IMPORTED_MODULE_1_ko__["a" /* default */].observable(!!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_Storage_Settings__["settingsGet"])('SubscriptionEnabled'));

		this.licenseTrigger.subscribe(function () {
			if (_this.subscriptionEnabled()) {
				__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6_Helper_Apps_Admin__["a" /* getApp */])().reloadLicensing(true);
			}
		});
	}

	LicensingPremAdminSettings.prototype.onBuild = function onBuild() {
		if (this.subscriptionEnabled()) {
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6_Helper_Apps_Admin__["a" /* getApp */])().reloadLicensing(false);
		}
	};

	LicensingPremAdminSettings.prototype.onShow = function onShow() {
		this.adminDomain(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_Storage_Settings__["settingsGet"])('AdminDomain'));
	};

	LicensingPremAdminSettings.prototype.showActivationForm = function showActivationForm() {
		__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Knoin_Knoin__["showScreenPopup"])(__webpack_require__(/*! View/Popup/Activate */ 187));
	};

	LicensingPremAdminSettings.prototype.showTrialForm = function showTrialForm() {
		__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_Knoin_Knoin__["showScreenPopup"])(__webpack_require__(/*! View/Popup/Activate */ 187), [true]);
	};
  ...
  */
	...
	LicensingPremAdminSettings.prototype.licenseIsUnlim = function licenseIsUnlim() {
  ...
  */
	...
	LicensingPremAdminSettings.prototype.licenseExpiredMomentValue = function licenseExpiredMomentValue() {
		var time = this.licenseExpired(),
		    momentUnix = __WEBPACK_IMPORTED_MODULE_2_moment___default.a.unix(time);

		return this.licenseIsUnlim() ? 'Never' : time && momentUnix.format('LL') + ' (' + momentUnix.from(__WEBPACK_IMPORTED_MODULE_2_moment___default()()) + ')';
	};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_Remote_Admin_Ajax__ = __webpack_require__(/*! Remote/Admin/Ajax */ 21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_Knoin_Knoin__ = __webpack_require__(/*! Knoin/Knoin */ 8);
...
var SecurityAdminSettings = (_dec = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_11_Knoin_Knoin__["command"])(function (self) {
	...
	function SecurityAdminSettings() {
		...
		this.verifySslCertificate = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(!!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_Storage_Settings__["settingsGet"])('VerifySslCertificate'));
		this.allowSelfSigned = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(!!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_Storage_Settings__["settingsGet"])('AllowSelfSigned'));
		...
		this.isTwoFactorDropperShown = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(false);
		this.twoFactorDropperUser = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable('');
		this.twoFactorDropperUser.focused = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(false);

		this.adminLogin = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_Storage_Settings__["settingsGet"])('AdminLogin'));
		this.adminLoginError = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(false);
		this.adminPassword = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable('');
		this.adminPasswordNew = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable('');
		this.adminPasswordNew2 = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable('');
		this.adminPasswordNewError = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(false);

		this.adminPasswordUpdateError = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(false);
		this.adminPasswordUpdateSuccess = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(false);
  ...
  */
	...
	SecurityAdminSettings.prototype.phpInfoLink = function phpInfoLink() {
		return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5_Common_Links__["g" /* phpInfo */])();
	};
...
var SocialAdminSettings = function () {
	function SocialAdminSettings() {
		...
		this.googleTrigger1 = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_3_Common_Enums__["SaveSettingsStep"].Idle);
		this.googleTrigger2 = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_3_Common_Enums__["SaveSettingsStep"].Idle);
		this.googleTrigger3 = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_3_Common_Enums__["SaveSettingsStep"].Idle);
		...
		this.facebookTrigger1 = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_3_Common_Enums__["SaveSettingsStep"].Idle);
		this.facebookTrigger2 = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_3_Common_Enums__["SaveSettingsStep"].Idle);
		...
		this.twitterTrigger1 = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_3_Common_Enums__["SaveSettingsStep"].Idle);
		this.twitterTrigger2 = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_3_Common_Enums__["SaveSettingsStep"].Idle);
		...
		this.dropboxTrigger1 = __WEBPACK_IMPORTED_MODULE_2_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_3_Common_Enums__["SaveSettingsStep"].Idle);
	}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_Common_Globals__ = __webpack_require__(/*! Common/Globals */ 7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_Storage_Settings__ = __webpack_require__(/*! Storage/Settings */ 10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_Remote_Admin_Ajax__ = __webpack_require__(/*! Remote/Admin/Ajax */ 21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_Helper_Apps_Admin__ = __webpack_require__(/*! Helper/Apps/Admin */ 38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_Knoin_Knoin__ = __webpack_require__(/*! Knoin/Knoin */ 8);
...
var LoginAdminView = (_dec = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_13_Knoin_Knoin__["view"])({
	...
	function LoginAdminView() {
		...
		_this.login = __WEBPACK_IMPORTED_MODULE_4_ko__["a" /* default */].observable('');
		_this.password = __WEBPACK_IMPORTED_MODULE_4_ko__["a" /* default */].observable('');

		_this.loginError = __WEBPACK_IMPORTED_MODULE_4_ko__["a" /* default */].observable(false);
		_this.passwordError = __WEBPACK_IMPORTED_MODULE_4_ko__["a" /* default */].observable(false);

		_this.loginErrorAnimation = __WEBPACK_IMPORTED_MODULE_4_ko__["a" /* default */].observable(false).extend({ 'falseTimeout': 500 });
		_this.passwordErrorAnimation = __WEBPACK_IMPORTED_MODULE_4_ko__["a" /* default */].observable(false).extend({ 'falseTimeout': 500 });

		_this.loginFocus = __WEBPACK_IMPORTED_MODULE_4_ko__["a" /* default */].observable(false);

		_this.formHidden = __WEBPACK_IMPORTED_MODULE_4_ko__["a" /* default */].observable(false);

		_this.formError = __WEBPACK_IMPORTED_MODULE_4_ko__["a" /* default */].computed(function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4____ = __webpack_require__(/*! $ */ 12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_____default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4____);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_key__ = __webpack_require__(/*! key */ 20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ko__ = __webpack_require__(/*! ko */ 2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_Storage_Settings__ = __webpack_require__(/*! Storage/Settings */ 10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_Remote_Admin_Ajax__ = __webpack_require__(/*! Remote/Admin/Ajax */ 21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_Stores_Admin_Domain__ = __webpack_require__(/*! Stores/Admin/Domain */ 96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_Stores_Admin_Plugin__ = __webpack_require__(/*! Stores/Admin/Plugin */ 120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_Stores_Admin_Package__ = __webpack_require__(/*! Stores/Admin/Package */ 119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_Helper_Apps_Admin__ = __webpack_require__(/*! Helper/Apps/Admin */ 38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_Knoin_Knoin__ = __webpack_require__(/*! Knoin/Knoin */ 8);
...
var PaneSettingsAdminView = (_dec = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_10_Knoin_Knoin__["view"])({
	...
	function PaneSettingsAdminView() {
		...
		_this.adminDomain = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_4_Storage_Settings__["settingsGet"]('AdminDomain'));
		_this.version = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].observable(__WEBPACK_IMPORTED_MODULE_4_Storage_Settings__["appSettingsGet"]('version'));

		_this.capa = !!__WEBPACK_IMPORTED_MODULE_4_Storage_Settings__["settingsGet"]('PremType');
		_this.community = false;

		_this.adminManLoading = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].computed(function () {
		...
		_this.adminManLoadingVisibility = __WEBPACK_IMPORTED_MODULE_3_ko__["a" /* default */].computed(function () {
...
var DomainAliasPopupView = (_dec = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12_Knoin_Knoin__["popup"])({
	...
	function DomainAliasPopupView() {
		...
		_this.alias = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('');

		_this.domains = __WEBPACK_IMPORTED_MODULE_9_Stores_Admin_Domain__["a" /* default */].domainsWithoutAliases;

		_this.domainsOptions = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].computed(function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_____default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4____);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ko__ = __webpack_require__(/*! ko */ 2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_key__ = __webpack_require__(/*! key */ 20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_Common_Translator__ = __webpack_require__(/*! Common/Translator */ 9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_Remote_Admin_Ajax__ = __webpack_require__(/*! Remote/Admin/Ajax */ 21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_Knoin_Knoin__ = __webpack_require__(/*! Knoin/Knoin */ 8);
...
var PluginPopupView = (_dec = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_11_Knoin_Knoin__["popup"])({
	...
	function PluginPopupView() {
		...
		_this.saveError = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('');

		_this.name = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('');
		_this.readme = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable('');

		_this.configures = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observableArray([]);

		_this.hasReadme = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].computed(function () {
			return '' !== _this.readme();
		});
		_this.hasConfiguration = __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].computed(function () {
		...
		if (oPlugin) {
			...
			if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8_Common_Utils__["isNonEmptyArray"])(config)) {
				this.configures(__WEBPACK_IMPORTED_MODULE_4_____default.a.map(config, function (item) {
					return {
						'value': __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(item[0]),
						'placeholder': __WEBPACK_IMPORTED_MODULE_5_ko__["a" /* default */].observable(item[6]),
						'Name': item[1],
						'Type': item[2],
						'Label': item[3],
						'Default': item[4],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_App_Admin__ = __webpack_require__(/*! App/Admin */ 177);

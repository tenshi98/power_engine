<link rel="stylesheet" href="<?php echo DB_SITE ?>/LIBS_js/avgrund/style.css">
<link rel="stylesheet" href="<?php echo DB_SITE ?>/LIBS_js/avgrund/avgrund.css">
<script src="<?php echo DB_SITE ?>/LIBS_js/avgrund/jquery.avgrund.js"></script>
<script>

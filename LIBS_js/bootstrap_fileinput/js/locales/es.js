...
(function ($) {
    ...
    $.fn.fileinputLocales['es'] = {
        ...
        msgSizeTooSmall: 'El archivo "{name}" (<b>{size} KB</b>) <br/>es demasiado pequeño y debe ser mayor de <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'El archivo "{name}" (<b>{size} KB</b>) <br/>excede el tamaño máximo permitido de <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'Debe seleccionar al menos <b>{n}</b> {files} a cargar.',
        msgFilesTooMany: 'El número de archivos seleccionados a cargar <b>({n})</b> <br/>excede el límite máximo permitido de <b>{m}</b>.',
        ...
        msgInvalidFileType: 'Tipo de archivo no válido para "{name}". <br/>Sólo se permiten archivos de tipo "{types}".',
        msgInvalidFileExtension: 'Extensión de archivo no válido para "{name}". <br/>Sólo se permiten archivos "{extensions}".',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
